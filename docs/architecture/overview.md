...
Under this approach, factory functions are used to dynamically generate application components on an as-needed basis.
...
A flat architecture is generally preferred where feasible.
...
Nested function calls are only used when they provide an improvement to overall maintainability.
